...
<s:layout-render name="/WEB-INF/jsp/adminLayout.jsp" title="Création d'une chaîne de TV">
	<s:layout-component name="include">
		...
		<script src = "../js/adnjoy/chanel/Create.js" ></script>
  ...
  <s:layout-component name="body">
  	<div id="createChanel">
  		<div id="filterChanel"></div>
  		<div id="gridChanel"></div>
  	</div>
